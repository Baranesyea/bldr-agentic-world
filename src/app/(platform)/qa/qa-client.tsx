...
export default function QAPageClient({
  ...
  const [questions] = useState<ForumQuestion[]>(initialQuestions);
  ...
  const handleAnswer = async (questionId: string) => {
    ...
    // For now, answers still go to localStorage via the old forum lib
    // TODO: wire to API route when user auth is available
    try {
      // Dynamic import to use the client-side localStorage-based forum lib
      const forumLib = await import("@/lib/forum");
      let userName = "משתמש";
      let userAvatar = "";
