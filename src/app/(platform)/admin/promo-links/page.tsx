              ...
              <thead>
                <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                  {["שם", "קוד", "ימים", "נוצר", "שימושים", "סטטוס", "פעולות"].map(h => (
                    <th key={h} style={{ padding: "10px 12px", textAlign: "left", color: "rgba(240,240,245,0.7)", fontWeight: 500, whiteSpace: "nowrap" }}>
                      {h}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {links.map(link => (
                  <tr key={link.id} style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                    ...
                    <td style={{ padding: "12px", color: "rgba(240,240,245,0.7)" }}>{link.trialDays}</td>
                    ...
                    <td style={{ padding: "12px", display: "flex", gap: "6px" }}>
                      <button onClick={() => copyLink(link.code)} style={{
                        ...
                        background: "rgba(255,255,255,0.04)", color: "rgba(240,240,245,0.7)", fontSize: "11px", cursor: "pointer",
                      }}>
